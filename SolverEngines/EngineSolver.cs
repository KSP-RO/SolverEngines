...
public class EngineSolver
{
    ...
    virtual public void CalculatePerformance(double pressure, double temperature, double velocity, double airRatio, double commandedThrottle, double flowMult, double ispMult)
    {
        fuelFlow = 0d;
        Isp = 0d;
        thrust = 0d;
